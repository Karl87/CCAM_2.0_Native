...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        NSLog(@"%f,%f",CCamViewWidth,CCamViewHeight);
        
        if (CCamViewHeight/CCamViewWidth == 1024/768) {
            isPad = YES;
        }
...
//
        ...
        NSLog(@"%@****%@****%@",region,cellAnimation.character.serie.regionType,regionArray);
...
//        [alert show];
        ...
        if ([TutorialHelper sharedManager].autoShowControlTutorial) {
