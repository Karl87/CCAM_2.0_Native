...
@interface CCFollowViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,strong) NSMutableArray *follows;
@property (nonatomic,strong) UITableView *followTable;
@end

@implementation CCFollowViewController
...
- (void)loadFollows{
    ...
    [manager POST:CCamGetFollowURL parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
