...
- (void)viewDidLoad {
    ...
    [_platforms addObject:@"bandMobile"];
    if ([WXApi isWXAppInstalled]&&[WXApi isWXAppSupportApi]) {
        [_platforms addObject:@"bandWechat"];
    }
    [_platforms addObject:@"bandWeibo"];
//    if ([QQApiInterface isQQInstalled]&&[QQApiInterface isQQSupportApi]){
        [_platforms addObject:@"bandQQ"];
//    }
    [_platforms addObject:@"bandFacebook"];
...
//                break;
//        }
        cell.type = [_platforms objectAtIndex:indexPath.row];
        cell.info = _userInfo;
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        cell.accessoryType=UITableViewCellAccessoryDisclosureIndicator;
        return cell;
