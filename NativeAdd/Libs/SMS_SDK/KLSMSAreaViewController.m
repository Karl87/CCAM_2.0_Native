...
@interface KLSMSAreaViewController (){
    NSMutableData*_data;
    int _state;
    NSString* _duid;
    NSString* _token;
...
@implementation KLSMSAreaViewController
@synthesize names;
@synthesize keys;
@synthesize table;
@synthesize search;
...
- (void)viewDidLoad {
    ...
    [table setContentInset:CCamScrollInset];
    [table setScrollIndicatorInsets:CCamScrollInset];
    [self.view addSubview:table];
    search.frame = CGRectMake(0, CCamNavigationBarHeight, self.view.frame.size.width, 44);
